# Estrutura de Topicos — Referência do Projeto

Este documento detalha a estrutura planejada da apresentação. Cada bloco tem um objetivo narrativo e os Topicos podem ser ajustados conforme necessidade.

A apresentação tem aproximadamente 14–18 Topicos, organizados em 5 blocos.

---

## Bloco 1 — O Problema (Topicos 1–3)

**Objetivo narrativo:** Criar urgência. Mostrar que o modo atual de usar IA para código é insustentável em produção.

### Topico 1: Hook — "O que é Vibe Coding?"
...
- Este é o Topico-chave que justifica todo o resto da apresentação

---

## Bloco 2 — A Evolução (Topicos 4–5)

**Objetivo narrativo:** Mostrar que existe um caminho maduro. Transição de problema para solução.

### Topico 4: De Prompt Engineering para Context Engineering
...
### Topico 5: Spec-Driven Development
...
### Topico 7: Spec-Kit — A Constituição do Projeto
...
### Topico 8: GSD (Get Shit Done) — Contexto Fresco, Qualidade Constante
...
### Topico 9: BMAD — Simulando um Time Completo
...
## Bloco 4 — O Novo Papel (Topicos 11–13)

**Objetivo narrativo:** Redefinir a identidade profissional do desenvolvedor.

### Topico 11: O Dev virou PM
- Com BMAD, você não programa — você orquestra
- Funções novas: definir requisitos, validar entregas, priorizar tarefas
- A IA é o dev de Elite(porque? comparaçao de % de humanos vs IA em codeforces[fazer research atual]); você é o PM/Arquiteto

### Topico 12: O Paradoxo do Júnior
- A Escada Quebrada — Quem serão os seniores de 2032?
- Desaparecimento de vagas júnior: 32% das contratações em Big Tech (2019) → 7% (2026)
- O paradoxo: sem contratação de juniores hoje, não há seniores em 2032
- O degrau não sumiu — mudou de forma: novas competências (pensamento sistêmico, validação, orquestração, spec-writing)
- Modelo manual-first + IA: comprime maturação de 24 para 9-18 meses
- Métrica principal: 78% redução em contratações de recém-formados

### Topico 13: Skills que Agora Importam
...
## Bloco 5 — Impacto e Encerramento (Topicos 14–16)

**Objetivo narrativo:** Provar o valor com números e fechar com chamada à ação.

### Topico 14: ROI e Linha do Tempo
...
- Métrica: 11 semanas para ROI completo
 - **Retomar o gancho do Tópico 8 (GSD): Nyquist Validation / feedback loop** → por que velocidade só vira ROI quando existe verificação rápida e rastreável (redução de risco/retrabalho)

### Topico 15: Cases Reais
